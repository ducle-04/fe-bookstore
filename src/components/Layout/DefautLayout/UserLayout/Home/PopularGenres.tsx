...
const genres = [
    { label: "TIỂU THUYẾT", cover: "https://down-vn.img.susercontent.com/file/vn-11134207-7qukw-lfgebc23iq9h5a" },
    { label: "TRUYỆN NGẮN", cover: "https://cdn0.fahasa.com/media/flashmagazine/images/page_images/danh_tac_van_hoc_viet_nam___truyen_ngan_khai_hung/2023_01_07_10_25_14_1-390x510.jpg" },
    { label: "THIẾU NHI", cover: "https://cf.shopee.vn/file/5e958c8b7354ee8e341137dfb69b0aea" },
    { label: "TÂM LÝ HỌC", cover: "https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1442726934i/4865.jpg" },
    { label: "NGHỆ THUẬT SỐNG", cover: "https://cdn0.fahasa.com/media/catalog/product/8/9/8935086856772.jpg" },
    { label: "KHOA HỌC VIỄN TƯỞNG", cover: "https://mtg.1cdn.vn/2020/09/25/www-motthegioi-vn_dgftlxrozs10awv1lxrodxlldc1rag9hlwhvyy1nawetdhvvbmctagf5lw5oyxqtzte1nja2ntqzodi4nja-.jpg" },
    { label: "LỊCH SỬ", cover: "https://down-vn.img.susercontent.com/file/vn-11134207-7r98o-lnryx38vuu3xe8" },
    { label: "KỸ NĂNG SỐNG", cover: "https://cdn0.fahasa.com/media/catalog/product/8/9/8934974186120.jpg" },
];
            ...
            <div className="relative flex items-center">
                ...
                <div className="grid gap-5 w-full" style={{ gridTemplateColumns: `repeat(${VISIBLE}, minmax(0, 1fr))` }}>
                    {visibleGenres.map((genre, i) => (
                        <motion.div
                            key={genre.label + startIndex + i}
                            initial={{ opacity: 0, y: 40, scale: 0.95 }}
                            animate={isInView ? { opacity: 1, y: 0, scale: 1 } : { opacity: 0, y: 40, scale: 0.95 }}
                            transition={{
                                duration: 0.5,
                                delay: i * 0.05,   // stagger nhẹ
                                ease: "easeOut"
                            }}
